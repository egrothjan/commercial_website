...
const DESCRIPTIONS: Record<string, string> = {
  "bronx-fire":
    "Client: The New York Times\n\nWhen the main fire-safety system catastrophically failed in a Bronx apartment building, 17 residents lost their lives.\nThrough smoke analysis and architectural reconstruction, this piece steps viewers through how the tragedy unfolded.",
  "sow-et-al":
    "Client: National Lawyers Guild\n\nGraphic analysis uncovering widespread and pervasive constitutional violations by the NYPD during the 2020 George Floyd protests. \nUsed as key evidence in a successful class-action lawsuit.",
  "death-flights":
    "Client: Centro Prodh\n\nVisual reconstruction of one of the most clandestine programs of Mexico’s so-called Dirty War, bringing testimony to life and revealing the systematic nature of the Death Flights in a nationally aired documentary.",
  donors:
    "Client: The New York Times\n\nData visualization revealing how just 158 families supplied nearly half of the early money in the race for the White House.",
  "david-bowie-3d":
    "Client: The New York Times\n\nA close look at Bowie’s meticulous eye for detail and the way he defied gender and social conventions in his blockbuster museum retrospective, *David Bowie Is.*",
  "diary-ed-sheeran":
    "Client: The New York Times\n\nAnimated data visualizations deconstruct how Ed Sheeran, Johnny McDaid, and Steve Mac built the most-streamed track of 2017.",
  "play-magazine":
    "Client: PLAY Magazine\n\nDesigned the visual identity for the inaugural issue of PLAY, a cookbook-magazine featuring recipes, essays, and artwork from a community of queer chefs, writers, and artists.",
  "zhiyun-xs": "Client: Snakk Studio\n\nProduct visualization and launch campaign for the Smooth-XS.",
  "mexican-metro":
    "Client: The New York Times\n\nAn analysis shows the serious construction flaws behind a tragedy that threatened two of Mexico’s most prominent figures.",
  "dixie-fire-weather":
    "Client: The New York Times\n\nSee how the Dixie Fire created its own weather. Using high-resolution radar data, which picked up ash particles from smoke plumes and water droplets from clouds, a 3-D model of the Dixie Fire’s massive thunderclouds was constructed.",
  antarctica:
    "Client: The New York Times\n\nA four-part documentary series exploring life and science in Antarctica – on, above, and below the ice. ",
  pluto:
    "Client: The New York Times\n\nFollow New Horizons glide through space and set foot on an alien world, three billion miles from the warmth of the sun.",
  cern:
    "Client: The New York Times\n\nImmersive documentary exploring particle collisions at CERN’s Large Hadron Collider.",
  "usain-bolt":
    "Client: The New York Times\n\nHow does Bolt compare to the full Olympic field in the 100-meter dash – not just this year, but against every Olympic medalist since 1896? To answer that question, a massive track was created with 88 lanes – one for every medal awarded in the 100-meter dash in the modern Olympics.",
  "olympics-ar":
